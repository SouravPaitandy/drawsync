...
export default function Toolbar({ brushColor, setBrushColor, brushSize, setBrushSize, tool, setTool }) {
  ...
  return (
    <>
      ...
      <div className="fixed left-1/2 transform -translate-x-1/2 top-16 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-lg shadow-lg z-40 px-4 py-2">
        <div className="flex items-center gap-2">
          <button
            onClick={() => setTool('pen')}
            className={`p-2 rounded-md transition-colors ${tool === 'pen' 
          ...
          <button
            ...
            className={`p-2 rounded-md transition-colors ${tool === 'eraser' 
              ? 'bg-blue-500 text-white' 
              : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            title="Eraser (E)"
          >
          ...
          <button
            ...
            className={`p-2 rounded-md transition-colors ${tool === 'line' 
              ? 'bg-blue-500 text-white' 
              : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            title="Line (L)"
          >
          ...
          <button
            ...
            className={`p-2 rounded-md transition-colors ${tool === 'rect' 
              ? 'bg-blue-500 text-white' 
              : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            title="Rectangle (R)"
          >
          ...
          <button
            ...
            className={`p-2 rounded-md transition-colors ${tool === 'ellipse' 
              ? 'bg-blue-500 text-white' 
              : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600'}`}
            title="Ellipse (E)"
          >
          ...
          >
            {isSidebarOpen ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5" />
            </svg> : <ArrowRight className='w-5 h-5'/>}
          </button>
        </div>
      </div>
      
      {/* Side Toolbar - Left Side - Colors and Size */}
      <div 
